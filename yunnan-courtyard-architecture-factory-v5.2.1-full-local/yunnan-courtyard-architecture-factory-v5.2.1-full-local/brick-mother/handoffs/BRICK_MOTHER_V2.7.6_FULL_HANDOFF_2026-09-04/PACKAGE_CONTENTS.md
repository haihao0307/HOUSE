...
`BRICK_MOTHER_V2.7.6_FULL_HANDOFF_2026-09-04-<short_sha>.zip`
...
4. `GITHUB_BUILD_IDENTITY.json`
   记录精确源提交、分支、PR 状态、冻结文件哈希、在线入口与审批状态。
5. `PACKAGE_MANIFEST_SHA256.json`
   记录包内所有文件的路径、字节数与 SHA256。
6. `PACKAGE_BUILD_REPORT.json`
   记录 ZIP 文件名、字节数、SHA256、完整性结果和审批状态。
7. `README_FIRST.md`
   简短启动说明与边界。

## 2. `source/brick-mother/`
...
2. ZIP 由 GitHub Actions 工作流生成并作为 artifact 保存 90 天。
