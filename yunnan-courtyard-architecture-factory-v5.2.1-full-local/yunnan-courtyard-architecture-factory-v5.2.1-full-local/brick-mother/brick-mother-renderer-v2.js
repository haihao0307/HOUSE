...
void main() {
  ...
  float valuePivot = uFamily == 0 ? 0.30 : (uFamily == 1 ? 0.39 : 0.37);
  float valueContrast = uFamily == 0 ? 1.86 : (uFamily == 1 ? 1.80 : 1.84);
  float contrastedLuma = clamp((outputLuma - valuePivot) * valueContrast + valuePivot, 0.0, 1.0);
