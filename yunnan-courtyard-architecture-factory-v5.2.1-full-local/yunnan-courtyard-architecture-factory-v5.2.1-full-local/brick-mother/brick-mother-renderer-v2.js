...
class BrickRenderer {
  ...
  focus(index) {
    ...
    this.camera.distance = Math.max(2.90, Math.max(m.mesh.dims.x, m.mesh.dims.z) * 1.34);
    this.camera.yaw = 0.82 + m.yaw * 0.25;
    this.camera.pitch = 0.20;
  }
